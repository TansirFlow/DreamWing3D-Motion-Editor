...
class Basic_Kick():
    ...
    def __init__(self, base_agent : Base_Agent) -> None:
        ...
        self.bias_dir = [0,0,26,29,0][self.world.robot.type]
        self.ball_x_limits = ((0.2,0.21), (0.2,0.21), (0.19,0.22), (0.2,0.215), (0.2,0.21))[r_type]
        self.ball_y_limits = ((-0.125,0.095), (-0.125,0.095), (-0.12,-0.1), (-0.13,-0.105), (-0.125,0.095))[r_type]
